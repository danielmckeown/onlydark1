...
url = "http://www.illustris-project.org/api/Illustris-1-Dark/snapshots/135/subhalos/" + search_query
...
while n < len(c):
	...
	print id
	url = "http://www.illustris-project.org/api/Illustris-1-Dark/snapshots/135/subhalos/" + str(id)
	print url
